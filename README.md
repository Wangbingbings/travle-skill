...
**知行合一：up主已成功用这个skill实践青岛，合肥的旅途计划**
...
git clone https://github.com/your-username/fable-travel.git](https://github.com/Wangbingbings/travel-skill/
帮我配置其中的两个skill并确保能被agent正常发现
